    ...
    return(
        <header className={styles.headerContainer}>
            <nav className={styles.navWeb}>
                ...
                {props.token?
                <div className={styles.icon} style={{backgroundImage: props.flagGoogle ? `url(${props.profilePic})` : `url(https://luxxor.herokuapp.com/usersPhoto/${props.profilePic})`}} onClick={clickHandler}></div>                
