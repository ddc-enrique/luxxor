...
const usersAction = {
    signIn: (userSignIn) =>{        
        return async (dispatch, getState) =>{
            try {
                let response = await axios.post("https://luxxor.herokuapp.com/api/user/sign-in", userSignIn)
    ...
    signUp: (userSignUp) =>{
        return async (dispatch, getState) =>{
            try {
                let response = await axios.post("https://luxxor.herokuapp.com/api/user/sign-up", userSignUp)
    ...
    signWithLocal: (token)=>{
        return async (dispatch)=>{
            try {
                let response = await axios.get("https://luxxor.herokuapp.com/api/verifyToken", {
                    headers: {
    ...
    getUserData: (id, token) => {
        return async (dispatch) => {
            let response = await axios.get(`https://luxxor.herokuapp.com/api/user/edit-profile/${id}`, {
                headers: {
                    Authorization: "Bearer " + token
                }
            })
    ...
    sendMail:(eMail)=>{
        return async (dispatch)=>{
            let response =await axios.post("https://luxxor.herokuapp.com/api/user/mail-password",{eMail})
    ...
    verifyIdMail:(id,type)=>{
        return async (dispatch)=>{
            if(type==="VERIFICAR USUARIO"){
                let response = await axios.get(`https://luxxor.herokuapp.com/api/user/verifyId/${id}`)
                if(response.data.success) return response.data.success
            }else{
                let response = await axios.get(`https://luxxor.herokuapp.com/api/userverify-mail/${id}`)
                if(response.data.success){
                    return response.data.success
                }
            }
    ...
    changePassword:(eMail,password)=>{
        return async (dispatch)=>{
            let response = await axios.put("https://luxxor.herokuapp.com/api/user/change-password",{eMail,password})
            if(response.data.success) return response.data.success
        }
    },
    banAccount:(id)=>{
        return async (dispatch)=>{
            let response = await axios.put(`https://luxxor.herokuapp.com/api/user/bann-user/${id}`)
            if(response.data.success) return response.data.success
        }
    },
    editDataUser: (id, flagEdit, token, dataUser) => {
        return async (dispatch) => {
            const url = `https://luxxor.herokuapp.com/api/user/edit-profile/${id}`
    ...
    sendNewBill: (userId, amount, shopCart, shipping, methodPayment, token) => {
        return async () => {
            ...
            let response = await axios.post("https://luxxor.herokuapp.com/api/sales", data , {
                    headers: {
                        Authorization: "Bearer " + token
                    }
            })
